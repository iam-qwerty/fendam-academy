...
export const Route = createFileRoute('/_instructor/instructor/submissions')({
...
function InstructorSubmissionsPage() {
                  ...
                  <div className="mt-4 rounded-lg border border-border p-4 space-y-3">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <Label htmlFor="score">
                          Score (max {sub.assignment.maxScore})
                        </Label>
                        <Input
                          id="score"
                          type="number"
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        disabled={
                          !gradeScore || gradeMutation.isPending
                        }
                      >
