    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="pt-24 pb-20 lg:pt-36 lg:pb-28 animate-fade-up stagger-1 spotlight overflow-hidden">
          <div
            className="float-shape w-16 h-16 top-24 left-[12%] rotate-12 hidden lg:block"
            style={{ animationDelay: '0s' }}
          />
          <div
            className="float-shape w-10 h-10 top-40 right-[15%] rotate-45 hidden lg:block"
            style={{ animationDelay: '3s' }}
          />
          <div
            className="float-shape w-8 h-8 bottom-20 left-[20%] -rotate-6 hidden lg:block"
            style={{ animationDelay: '6s' }}
          />
          <div
            className="float-shape w-12 h-12 bottom-32 right-[10%] rotate-12 hidden lg:block"
        ...
        <section
          id="how-it-works"
          className="py-24 lg:py-32 border-t border-border animate-fade-up stagger-4"
        >
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="max-w-2xl mb-16">
              <div className="inline-flex items-center gap-2 mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
              {STEPS.map((step, i) => (
                <div
                  key={step.number}
                  className={cn(i < STEPS.length - 1 && 'md:step-connector')}
                >
        ...
        <section
          id="platform"
          className="py-24 lg:py-32 border-t border-border animate-fade-up stagger-5"
        >
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="max-w-2xl mb-16">
              <div className="inline-flex items-center gap-2 mb-3">
      ...
      <footer className="border-t border-border">
        <div className="container mx-auto px-6 max-w-5xl py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                {['AI & Machine Learning', 'Full-Stack Development', 'Cybersecurity', 'Network Hacking'].map(
                  (t) => (
                    <li key={t}>
                      <Link
                        to="/#tracks"
          ...
          <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} FendAm Academy. All rights
              reserved.
            </p>
            <div className="flex gap-6 text-sm text-muted-foreground">
              {['Twitter', 'LinkedIn', 'GitHub'].map((t) => (
                <span
                  key={t}
