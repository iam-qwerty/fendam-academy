    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="card-clean hover-lift animate-fade-up stagger-1">
          ...
          <Progress value={data.progressPercent} className="h-2 rounded-full" />
        </div>
        ...
        <div className="card-clean hover-lift animate-fade-up stagger-3">
          <div className="flex items-center justify-between mb-6">
            <div className="w-11 h-11 rounded-xl bg-secondary flex items-center justify-center">
              <HugeiconsIcon icon={CourseIcon} className="w-5 h-5 text-primary" />
            </div>
          </div>
          <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-1">
            Up Next
          ...
          {data.nextLesson ? (
            ...
            <div className="flex flex-col items-center justify-center py-4 text-center">
              ...
              <p className="text-xs text-muted-foreground">No pending lessons.</p>
            </div>
          )}
        </div>
      </div>
