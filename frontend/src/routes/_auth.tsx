      ...
      <div className="flex-1 flex items-center justify-center p-6 glow-mesh">
        ...
        >
          <div className="glass p-8 md:p-10 rounded-[2.5rem] border-white/10 shadow-2xl relative overflow-hidden group">
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/20 blur-[80px] -z-10 group-hover:bg-primary/30 transition-colors" />
            <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-purple-500/10 blur-[80px] -z-10 group-hover:bg-purple-500/20 transition-colors" />
