...
export const Route = createFileRoute('/_admin/admin/instructor-modules')({
  component: AdminInstructorModulesPage,
})
...
function AdminInstructorModulesPage() {
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: ['admin', 'instructor-modules'],
      })
    },
    onError: () => {
  ...
  const removeMutation = useMutation({
    mutationFn: (assignmentId: string) =>
      apiFetch(`/admin/instructor-modules/${assignmentId}`, {
        method: 'DELETE',
      }),
    onSuccess: () => {
                  ...
                  >
                    <td className="px-4 py-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {a.instructor.email ||
                            a.instructor.id.slice(0, 12) + '...'}
                        </p>
                      </div>
                    </td>
                    <td className="px-4 py-3 font-medium">{a.module.title}</td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Button
                        ...
                        size="sm"
                        disabled={
                          removing === a.id || removeMutation.isPending
                        }
